...
<head>
    ...
    <title>View Teachers Details</title>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="viewTeachersDetail.php" class="active">View Teachers Detail</a></li>
                            </ul>
                        </li>
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">View Teachers Detail</li>
                            </ul>
                        </div>
