                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li>
                                    <a href="teacherEvalution"> Evaluate Your Teacher</a>
                                </li>
                            </ul>
                        </li>
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="ResultForPlacement.php" class="active">Result For Placement</a>
                                </li>
                            </ul>
                        </li>
                        <li class="submenu">
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Result of Your Placement preference </h3>
                            <ul class="breadcrumb">
