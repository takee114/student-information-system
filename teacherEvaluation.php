...
<head>
    ...
    <title>Evaluate your teaachers</title>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li>
                                    <a href="teacherEvaluation.php" class="active"> Evaluate Your Teacher</a>
                                </li>
                            </ul>
                        </li>
                        <li class="submenu">
                        ...
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="index.php">Evalution</a>
                                </li>
                                <li class="breadcrumb-item active">Evaluate Your Teacher</li>
                            </ul>
                        </div>
                    </div>
                </div>
