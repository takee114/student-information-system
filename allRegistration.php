                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="allRegistration.php" class="active">View All Registration</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">View Registered course</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Registration</a></li>
                                <li class="breadcrumb-item active">View All Registration</li>
                            </ul>
                        </div>
                    </div>
                </div>
