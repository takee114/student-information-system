                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-user-graduate"></i>
                                <span>EVALUATION</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li>
                                    <a href="teacherEvaluation.php"> Evaluate Your Teacher</a>
                                </li>
                            </ul>
                        </li>
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="recordPreference.php" class="active">Record Preference</a></li>
                                <li>
                                    <a href="ResultForPlacement.php">Result For Placement</a>
                                </li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fas fa-building"></i> <span>TRANSFERS</span>
                                <span class="menu-arrow"></span></a>
                            <ul>
                                <li>
                                    <a href="departmentTransfer.php">Department Transfer</a>
                                </li>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-book-reader"></i>
                                <span>REGISTRATION</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <a href="allRegistration.php">View All Registration</a>
                                </li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fas fa-book-reader"></i> <span> GRADE</span>
                                <span class="menu-arrow"></span></a>
                            <ul>
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Record preference</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="index.php">Placement</a>
                                </li>
                                <li class="breadcrumb-item active">Record preference </li>
                            </ul>
                        </div>
                    </div>
                </div>
